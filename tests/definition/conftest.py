...
definitionsstore.legacy_definitions_storage.get_with_ver = wrap_storage_get_with_error_condition(
        definitionsstore.legacy_definitions_storage.get_with_ver,
